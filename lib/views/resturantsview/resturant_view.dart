              ...
              children: [
                Stack(
                  ...
                  children: [
                    ...
                    Positioned(top: 40, left: 0, right: 0, child: ResAppBar()),
                    Positioned(
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    decoration: BoxDecoration(
                                      ...
                                      color:
                                          const Color.fromARGB(255, 29, 5, 71),
                                    ),
                                    child: Row(
                                      mainAxisAlignment:
                      ...
                      child: Row(
                        ...
                        children: [
                          ...
                          CustomText(
                              ...
                              fontSize: 16),
                          CustomText(
                              text: 'Sushi', color: Colors.white, fontSize: 16),
                        ],
                      ),
                    ),
                  ],
                          ...
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              ...
                              return GestureDetector(
                                onTap: () {
                                  Get.to(MenuScreenView(image: data.image??'', name: data.name??'', desc: data.description??'', price: data.price??0));
                                },
                                child: Padding(
